...
const MemoryExplorerComponent: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-dark-950 overflow-hidden">
      {/* Header */}
      <div className="p-6 border-b border-dark-700/60 bg-dark-900 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-base font-bold text-slate-100">Trading Memory & Point-in-Time Reflection Log</h2>
            <p className="text-xs text-slate-400">
              Cross-run knowledge base: past decisions, market outcomes, and automated post-mortem lessons
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          <div className="relative">
            ...
            <input
              ...
              className="bg-dark-850 border border-dark-700 rounded-lg pl-8 pr-3 py-1.5 text-xs text-slate-200 placeholder-slate-500 focus:outline-none focus:border-brand-amber"
            />
          </div>

          <button
            onClick={loadMemory}
            className="flex items-center space-x-1.5 px-3 py-1.5 rounded-lg bg-dark-800 hover:bg-dark-750 border border-dark-700 text-xs font-mono text-slate-300"
          >
