...
class AgentState(MessagesState):
    ...
    investment_plan_structured: Annotated[
        dict[str, Any], "Compact canonical research-manager contract for downstream machine consumers"
    ]
    ...
    final_trade_decision_structured: Annotated[
        dict[str, Any], "Compact canonical portfolio-manager decision for downstream machine consumers"
    ]
