...
def create_market_movers_scanner(llm: Any) -> Callable[[ScannerState], dict[str, Any]]:
    def market_movers_scanner_node(state: ScannerState) -> dict[str, Any]:
        scan_date, _run_id = require_scan_context(state, node_name="market_movers_scanner")
