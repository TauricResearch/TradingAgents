...
- **NO INVENTED STATISTICS**: Do NOT cite probability percentages (e.g., "65% mean reversion probability"), standard deviation multiples (e.g., "2.5 standard deviations"), or similar statistical claims unless they appear verbatim in the research packet. If you must estimate, label it explicitly as "(Analyst estimate, unverified)".
