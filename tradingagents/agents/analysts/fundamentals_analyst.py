...
def create_fundamentals_analyst(llm: Any) -> Callable[[AgentState], dict[str, Any]]:
    def fundamentals_analyst_node(state: AgentState, /) -> dict[str, Any]:
        ...
        system_message = (
            ...
            "Specifically, use the provided **Earnings Calendar** to identify the NEXT "
            "earnings date — do NOT estimate or use outdated training data for catalysts.\n\n"
            ...
            "You MUST include the following lines verbatim in your report (fill in actual values). "
            "These exact phrases are parsed downstream — do not paraphrase, abbreviate, or omit them:\n\n"
            "- P/E ratio: <value>x\n"
            "- D/E ratio: <value>\n"
            "- Free cash flow: <+/-><%> YoY (or 'N/A' if not available)\n"
            "- Operating margin: <+/-><%>\n"
            "- Current ratio: <value>\n"
            "- Working capital: <$value> (positive/negative)\n\n"
            "Place these lines in the summary section or at the start of the key ratios section.\n\n"
            "## Normal Operation\n\n"
            "STRICT CONSTRAINTS:\n"
