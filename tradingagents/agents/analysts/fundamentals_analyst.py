...
def create_fundamentals_analyst(llm):
    def fundamentals_analyst_node(state):
        ...
        system_message = (
            ...
            + " Use the available tools: `get_fundamentals` for comprehensive company analysis, `get_balance_sheet`, `get_cashflow`, and `get_income_statement` for specific financial statements, `get_insider_transactions` for recent insider buying and selling, and `get_valuation` for a point-in-time valuation snapshot (market cap, P/E, P/B as of the analysis date; use it for valuation metrics whenever `get_fundamentals` reports them withheld)."
