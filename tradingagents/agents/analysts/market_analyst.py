...
def create_market_analyst(llm: Any) -> Callable[[AgentState], dict[str, Any]]:
    def market_analyst_node(state: AgentState, /) -> dict[str, Any]:
        ...
        system_message = (
            ...
            "If you detect any of the following catastrophic market conditions, describe them "
            "clearly as hard-stop risks. Do not emit special routing markers or control "
            "tokens in the report text.\n\n"
