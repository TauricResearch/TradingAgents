...
def create_bull_researcher(llm: Any, memory: Any) -> Callable[[AgentState], dict[str, Any]]:
...
"""
        ...
        current_bull_summary = (
            summary_section
            or str(investment_debate_state.get("current_bull_summary") or "").strip()
        )
