...
_ENV_OVERRIDES = {
    ...
    "TRADINGAGENTS_MAX_CASH_RESERVE_USD": "max_cash_reserve_usd",
    ...
    "TRADINGAGENTS_USE_ALPACA_MARKET_DATA": "use_alpaca_market_data",
