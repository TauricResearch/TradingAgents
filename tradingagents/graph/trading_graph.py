...
from tradingagents.dataflows.ticker_utils import to_yfinance_symbol
...
class TradingAgentsGraph:
    ...
    def propagate(self, company_name, trade_date, asset_type: str = "stock"):
        ...
        crypto pipeline (``"crypto"``) — the CLI auto-detects from the ticker;
        programmatic callers pass it explicitly. When ``checkpoint_enabled``
        is set in config, the graph is recompiled with a per-ticker SqliteSaver
