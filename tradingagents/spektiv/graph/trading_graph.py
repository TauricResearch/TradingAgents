...
from spektiv.agents import *
from spektiv.default_config import DEFAULT_CONFIG
from spektiv.agents.utils.memory import FinancialSituationMemory
from spektiv.agents.utils.agent_states import (
    AgentState,
    InvestDebateState,
    RiskDebateState,
)
from spektiv.dataflows.config import set_config

# Import the new abstract tool methods from agent_utils
from spektiv.agents.utils.agent_utils import (
    get_stock_data,
    get_indicators,
    get_fundamentals,
    get_balance_sheet,
