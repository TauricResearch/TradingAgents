...
Usage:
    US Stock Data:
        >>> from spektiv.dataflows.akshare import get_akshare_stock_data_us
        >>> data = get_akshare_stock_data_us("AAPL", "2024-01-01", "2024-12-31")

    Chinese Stock Data:
        >>> from spektiv.dataflows.akshare import get_akshare_stock_data_cn
        >>> data = get_akshare_stock_data_cn("000001", "2024-01-01", "2024-12-31")

    Auto-Detection (Recommended):
        >>> from spektiv.dataflows.akshare import get_akshare_stock_data
