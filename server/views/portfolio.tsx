      ...
      <section class="panel">
        ...
        <div style="overflow-x:auto">
          <table id="positions-table" class="positions-table">
            <thead>
              <tr>
                <th>Platform</th><th>Ticker</th><th>Qty</th><th>Avg Cost</th>
                <th>Current</th><th>Trend</th><th>Value (GBP)</th>
                <th>P&amp;L</th><th class="date-col">Entry</th><th>Thesis</th><th></th>
              </tr>
            </thead>
...
function updatePositionsTable(positions) {
  ...
  tbody.innerHTML = positions.map(function(p) {
    ...
    return '<tr>' +
      ...
      '<td style="font-family:Datatype,monospace;font-feature-settings:' + q + 'calt' + q + '1,' + q + 'liga' + q + '1">' + curPrice + '</td>' +
      '<td style="font-family:Datatype,monospace;font-feature-settings:' + q + 'calt' + q + '1,' + q + 'liga' + q + '1">' + curVal + '</td>' +
      '<td class="pnl-cell ' + pnlCls + '" style="font-family:Datatype,monospace;font-feature-settings:' + q + 'calt' + q + '1,' + q + 'liga' + q + '1">' + pnlStr + '</td>' +
