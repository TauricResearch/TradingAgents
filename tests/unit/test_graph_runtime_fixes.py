...
class TestToolsNodesRemoved:
    ...
    def test_graph_does_not_contain_any_tools_nodes(self):
        ...
        compiled_graph = setup.setup_graph(selected_analysts=["market", "social", "news", "fundamentals"])
        nodes = list(compiled_graph.nodes.keys())
...
class TestConditionalLogicDefensive:
    ...
    def test_should_continue_risk_analysis_handles_missing_latest_speaker(self):
        ...
        assert result in ["Aggressive Analyst", "Conservative Analyst", "Neutral Analyst", "Portfolio Manager"]
...
class TestPortfolioInitialState:
    ...
    def test_portfolio_run_initializes_ticker_analyses(self):
        ...
        with patch("tradingagents.graph.portfolio_graph.create_holding_reviewer"), \
...
class TestTradingGraphLogging:
    ...
    def test_log_state_handles_missing_investment_debate_fields(self):
        ...
        with patch("tradingagents.graph.trading_graph.create_llm_client") as mock_llm_client, \
