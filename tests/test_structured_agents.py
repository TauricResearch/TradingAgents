...
from handelsagenten.agents.analysts.sentiment_analyst import create_sentiment_analyst
from handelsagenten.agents.managers.research_manager import create_research_manager
from handelsagenten.agents.schemas import (
    PortfolioDecision,
    PortfolioRating,
    ResearchPlan,
    SentimentBand,
...
def test_invoke_structured_falls_back_when_result_is_none():
    ...
    from handelsagenten.agents.utils.structured import invoke_structured_or_freetext
