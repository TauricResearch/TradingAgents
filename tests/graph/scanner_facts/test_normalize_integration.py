...
@pytest.mark.parametrize(
    ...
    [
        ...
        "JBLU",
        "ON",
        "QBTS",  # smart_money_summary
        "NVDA",
        "AAPL",
        "MSFT",
        "AMZN",
        "TSLA",
        "AMD",  # gatekeeper + industry
        "ORCL",
        "NFLX",
        "PLTR",
        "MU",
        ...
        "EQIX",
        "CBRE",
        "PLD",  # industry_deep_dive
        "PM",
        "CL",
        "PG",
        "T",  # industry_deep_dive + gatekeeper
    ],
)
...
@pytest.mark.parametrize(
    "evidence,implication,expected_polarity",
    [
        # From smart_money_summary.md
        (
            "Breakout accumulation at $79.93 with 52-week high on high volume",
            "Supports strong technology sector alignment.",
            "bullish",
        ),
        (
            "Unusual volume spike at $21.52",
            "Confirms technology sector strength and ongoing momentum.",
            "bullish",
        ),
        ("Insider buying at $12.44", "Signaling auto/consumer cyclical sector revival.", "bullish"),
        (
            "Insider purchases at $21.5",
            "Suggests insider optimism despite broader energy sector volatility.",
            "bullish",
        ),
        # From industry_deep_dive_summary.md
        ("+41.75% (1-month), +17.59% (1-week)", "Strong short-term performance.", "bullish"),
        ("-8.79% (1-month), -3.11% (1-week)", "Negative short-term performance.", "bearish"),
        # From geopolitical_summary.md
        ("Brent Crude up +3.44%", "Geopolitical tension-related supply risk.", "bearish"),
        ("German CDS +13.01%", "Rising perceived risk.", "bearish"),
    ],
)
