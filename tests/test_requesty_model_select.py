...
class TestRequestyMainstreamFilter:
    def test_dropdown_prefers_mainstream_over_niche(self):
        ...
        with mock.patch.object(prompts, "_fetch_requesty_models", return_value=models), \
             mock.patch.object(prompts.questionary, "select", side_effect=fake_select):
            prompts.select_requesty_model("quick")
    ...
    def test_falls_back_to_all_when_no_mainstream(self):
        ...
        with mock.patch.object(prompts, "_fetch_requesty_models", return_value=models), \
             mock.patch.object(prompts.questionary, "select", side_effect=fake_select):
            prompts.select_requesty_model("deep")
...
class TestRequestyCancelExitsCleanly:
    def test_dropdown_cancel_exits(self):
        with mock.patch.object(prompts, "_fetch_requesty_models", return_value=[]), \
