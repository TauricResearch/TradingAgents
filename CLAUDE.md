...
This project is indexed by GitNexus as **TradingAgents** (1618 symbols, 2508 relationships, 60 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
