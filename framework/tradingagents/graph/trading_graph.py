...
from tradingagents.a_share import build_a_share_analysis_context, is_a_share_symbol
...
class TradingAgentsGraph:
    ...
    def propagate(
        ...
        """
        if asset_type == "stock" and is_a_share_symbol(company_name):
            asset_type = "a_share"
    ...
    def _log_state(self, trade_date, final_state):
        ...
        self.log_states_dict[str(trade_date)] = {
            ...
            "a_share_context": final_state.get("a_share_context", {}),
