...
from tradingagents.agents.utils.rating import parse_position_action, parse_rating
...
class SignalProcessor:
    ...
    def process_signal(self, full_signal: str) -> str:
        """Return a position action for A-share output, otherwise a legacy rating."""
        if "position action" in full_signal.lower():
            return parse_position_action(full_signal)
