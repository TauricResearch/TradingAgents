...
header (see :func:`handelsagenten.agents.schemas.render_pm_decision`).  The
deterministic heuristic in :mod:`handelsagenten.agents.utils.rating` is more
...
from handelsagenten.agents.utils.rating import parse_rating
