...
```
Configure with `llm_provider: "ollama"` or `llm_provider: "lm-studio"` in your config.
...
config["llm_provider"] = "openai"        # openai, google, anthropic, xai, deepseek, qwen, glm, openrouter, ollama, lm-studio, azure
