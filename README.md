...
## News
- [2026-08] **TradingAgents v0.4.0** released, a correctness release: point-in-time / look-ahead integrity across FRED macro, social sentiment, and the decision-log memory; more honest decision signals (REVIEW instead of a silent Hold, debate openers that don't fabricate); working CLI checkpoint resume; Trader price grounding; and the latest GPT-5.6 and GLM-5.3 models. See [CHANGELOG.md](CHANGELOG.md) for the full list.
